...
function complex_multiplier_config(this_block)
  ...
  this_block.addSimulinkInport('re_multiplicator');
  this_block.addSimulinkInport('im_multiplicator');
  ...
  data_re_out_port.setType('UFix_1_0');
  data_re_out_port.useHDLVector(false);
  data_im_out_port = this_block.port('data_im_out');
  data_im_out_port.setType('UFix_1_0');
  data_im_out_port.useHDLVector(false);
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('re_multiplicator').width ~= 16);
      this_block.setError('Input data type for port "re_multiplicator" must have width=16.');
    end

    if (this_block.port('im_multiplicator').width ~= 16);
      this_block.setError('Input data type for port "im_multiplicator" must have width=16.');
    end
