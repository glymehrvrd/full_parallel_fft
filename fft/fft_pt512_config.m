...
function fft_pt512_config(this_block)

  % Revision History:
  %
  %   11-Nov-2015  (18:04 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     d:\dell\Documents\ISE Projects\fft\fft\fft_pt512.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('fft_pt512');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('data_re_in').width ~= 512);
      this_block.setError('Input data type for port "data_re_in" must have width=512.');
    end

    if (this_block.port('data_im_in').width ~= 512);
      this_block.setError('Input data type for port "data_im_in" must have width=512.');
    end
  ...
  this_block.addFile('fft_pt16.vhd');
  this_block.addFile('fft_pt32.vhd');
  this_block.addFile('fft_pt512.vhd');
