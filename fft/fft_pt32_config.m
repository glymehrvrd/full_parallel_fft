...
function fft_pt32_config(this_block)
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('bypass').width ~= 5);
      this_block.setError('Input data type for port "bypass" must have width=5.');
    end
