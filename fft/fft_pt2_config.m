...
function fft_pt2_config(this_block)
  ...
  data_re_out_port.setType('UFix_2_0');
  data_im_out_port = this_block.port('data_im_out');
  data_im_out_port.setType('UFix_2_0');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('data_re_in').width ~= 2);
      this_block.setError('Input data type for port "data_re_in" must have width=2.');
    end

    if (this_block.port('data_im_in').width ~= 2);
      this_block.setError('Input data type for port "data_im_in" must have width=2.');
    end
